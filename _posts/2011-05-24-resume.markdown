...
*   **Voxel Ltd.**{: .cpy}
    ...
    *   **Engineering Manager @ White Label**
        ...
        *   Designed and developed .NET data importer web service integrating different travel agencies web sites using XML data structure to push customers orders in order to issue their flight tickets.
    ...
    *   **Software Engineer @ Cruise Search**
        ...
        *   Developed a FTP flat file downloader in C# which daily parses and imports into database updated cruises prices and a watchdog that reports when error occurs;
