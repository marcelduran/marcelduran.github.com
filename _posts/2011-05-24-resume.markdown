...
*   **Twitter Inc.**{: .cpy}
    ...
    *   **Web Performance Engineer**
        ...
        *   Profiled and found a 200ms seconds performance regression on new [twitter.com](https://twitter.com) framework related to CSS link tags and fixed with a non-trivial web performance optimization technique putting user experience latency back to normal;
